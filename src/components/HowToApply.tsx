			...
			<div className="container mx-auto px-4">
				...
				<div className="grid md:grid-cols-3 gap-8 mb-16">
					{steps.map((step, index) => (
						<div
							key={index}
							className="bg-black p-8 rounded-2xl hover:bg-gray-800 transition-colors duration-300"
						>
				...
				<div className="text-center">
					<Link
						to="/apply"
						className="px-8 py-4 text-xl font-bold text-black bg-yellow-400 rounded-full hover:bg-yellow-300 transition-all duration-300 transform hover:scale-105"
					>
						Apply for Season 2
					</Link>
				</div>
